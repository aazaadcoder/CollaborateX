...
export function WorkspaceSwitcher() {
  ...
  // this returns workspace id from the params 
  ...
  React.useEffect(() => {
    if(workspaces?.length){
      const workspace = workspaceId ? workspaces.find((ws) => ws._id === workspaceId) 
      : workspaces[0];
        ...
        <SidebarMenuItem>
          <DropdownMenu>
            ...
            >
              ...
              {isPending ? <Loader className="size-5 animate-spin"/> : null}
